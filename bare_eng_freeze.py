...
for epoch_num in range(epochs):
    ...
    with torch.no_grad():
        ...
        if best_total_corr / len(val_dataloader) < total_corr / len(val_dataloader):
            ...
            if os.path.exists('models/poopoo1.pth'):
                os.remove('models/poopoo1.pth')
            torch.save(model.state_dict(), 'models/poopoo1.pth')
...
model.load_state_dict(torch.load('C:/Users/hplis/PycharmProjects/social_ai/models/poopoo1.pth'))
